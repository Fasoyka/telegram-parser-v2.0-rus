...
Для массового добавления подготовьте архив `.zip` с файлами `.session` и используйте пункт "Массово добавить аккаунты (.zip)" в настройках. Все сессии будут распакованы в корневую директорию.
